package com.jazouli.geolocalisation;
...
import com.jazouli.geolocalisation.R.id;
...
public class MainActivity extends AppCompatActivity {
                ...
                if (location != null) {
                    try {
                        ...
                        textView3.setText(Html.fromHtml(
                                "<font color='#6200EE'><b>Nom de pays : </b><br></font>" + addresses.get(0).getCountryName()
                        ));
                        // afficher la localité dans le textview
                        textView4.setText(Html.fromHtml(
                                "<font color='#6200EE'><b>Localité : </b><br></font>" + addresses.get(0).getLocality()
                        ));
                        // afficher l’adresse dans le textview
                        textView5.setText(Html.fromHtml(
                                "<font color='#6200EE'><b>Adresse : </b><br></font>" + addresses.get(0).getAddressLine(0)
                        ));
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
    ...
    FusedLocationProviderClient usedLocationProviderClient = LocationServices.getFusedLocationProviderClient(this);
